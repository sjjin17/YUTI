...
import pipeline.consumer.ConsumerWorker;
...
public class HdfsSinkApplication {
    ...
    private final static String BOOTSTRAP_SERVERS = "j7a502.p.ssafy.io:9092";
    private final static String TOPIC_NAME = "mbti-result";
    private final static String GROUP_ID = "mbti-hdfs-save-consumer-group";
